...
sidebarTitle: Managing sandboxes
icon: "list-check"
description: "Manage E2B sandboxes — timeouts, metadata, listing, filtering, connecting, and shutdown. Sandboxes are persistent cloud environments for AI agents."
---
