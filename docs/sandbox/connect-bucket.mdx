...
sidebarTitle: "Connect storage bucket"
icon: "bucket"
description: "Mount Google Cloud Storage, Amazon S3, or Cloudflare R2 buckets inside E2B sandboxes using FUSE."
---

You can mount external cloud storage buckets inside a sandbox using FUSE file systems. This lets sandboxes read and write to your existing cloud storage.
