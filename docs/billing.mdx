...
| **Disk space** | 10 GB | 20 GB | Custom |

<Note>
Pro plan includes 100 concurrent sandboxes. Higher concurrency up to 1,100 is available as a purchasable [add-on](https://e2b.dev/dashboard?tab=billing). Higher disk space on Pro is available by contacting [support@e2b.dev](mailto:support@e2b.dev).
</Note>
