...
| `options`? | \{ `forceUpload`: `true`; `gzip`: `boolean`; `mode`: `number`; `resolveSymlinks`: `boolean`; `user`: `string`; \} | Copy options |
...
| ------ | ------ | ------ |
| <a id="alias"></a> `alias` | `string` | First alias from the build (for backward compatibility). **Deprecated** Use `name` instead. |
| <a id="buildid"></a> `buildId` | `string` | Build identifier. |
| <a id="name"></a> `name` | `string` | Name of the template. |
| <a id="tags"></a> `tags` | `string`[] | Tags assigned to this build. |
| <a id="templateid"></a> `templateId` | `string` | Template identifier. |
...
| Name | Type | Description |
| ------ | ------ | ------ |
| <a id="logentries"></a> `logEntries` | `LogEntry`[] | Log entries related to the status reason. |
| <a id="message"></a> `message` | `string` | Message with the status reason. |
| <a id="step"></a> `step`? | `string` | Step that failed. |
...
| Name | Type |
| ------ | ------ |
| <a id="dest"></a> `dest` | `PathLike` |
| <a id="forceupload"></a> `forceUpload`? | `true` |
| <a id="gzip"></a> `gzip`? | `boolean` |
| <a id="mode"></a> `mode`? | `number` |
| <a id="resolvesymlinks"></a> `resolveSymlinks`? | `boolean` |
| <a id="src"></a> `src` | `PathLike` \| `PathLike`[] |
...
| Name | Type | Description |
| ------ | ------ | ------ |
| <a id="buildid-1"></a> `buildID` | `string` | Build identifier. |
| <a id="logentries-1"></a> `logEntries` | `LogEntry`[] | Build log entries. |
| <a id="logs"></a> `logs` | `string`[] | Build logs (raw strings). **Deprecated** Use `logEntries` instead. |
| <a id="reason"></a> `reason`? | `BuildStatusReason` | Reason for the current status (typically for errors). |
| <a id="status"></a> `status` | `TemplateBuildStatus` | Current status of the build. |
| <a id="templateid-1"></a> `templateID` | `string` | Template identifier. |
...
| Name | Type | Description |
| ------ | ------ | ------ |
| <a id="buildid-2"></a> `buildId` | `string` | Build identifier associated with this tag. |
| <a id="createdat"></a> `createdAt` | `Date` | When this tag was assigned. |
| <a id="tag"></a> `tag` | `string` | Name of the tag. |
...
| Name | Type | Description |
| ------ | ------ | ------ |
| <a id="buildid-3"></a> `buildId` | `string` | Build identifier associated with this tag. |
| <a id="tags-1"></a> `tags` | `string`[] | Assigned tags of the template. |
