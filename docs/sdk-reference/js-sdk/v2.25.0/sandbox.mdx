...
static getFullInfo(sandboxId: string, opts?: SandboxApiOpts): Promise<{
  allowInternetAccess: undefined | boolean;
  cpuCount: number;
  endAt: Date;
  ...
  network:   | undefined
     | {
     allowOut: undefined | string[];
     allowPublicTraffic: undefined | boolean;
     denyOut: undefined | string[];
     maskRequestHost: undefined | string;
     rules: undefined | {};
    };
