...
```ts
optional language: RunCodeLanguage;
```
...
| ------ | ------ | ------ |
| <a id="cwd-1"></a> `cwd` | `string` | The working directory of the context. |
| <a id="id"></a> `id` | `string` | The ID of the context. |
| <a id="language-1"></a> `language` | `string` | The language of the context. |
