...
<CardGroup cols={2}>
  <Card title="Managing sandboxes" icon="list-check" href="/docs/sandbox/lifecycle">
  ...
  <Card title="Environment variables" icon="key" href="/docs/sandbox/environment-variables">
    Default metadata, global variables, and per-command overrides.
  </Card>
  <Card title="Connect storage bucket" icon="bucket" href="/docs/sandbox/connect-bucket">
